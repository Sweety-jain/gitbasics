...
/**
 * Created by Sweety Jain on 11/7/2017 at 10:50 AM.
 */
...
public final class QueryUtils {
    ...
    public static List<BookList> fetchBookListData(String requestUrl) {
        ...
        Log.v("Queryutils.java","fetchBookListData");
    ...
    private static List<BookList> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            Log.v("QueryUtils.this","title:"+title);
              ...
              //  String subtitle = volumeInfo.getString("subtitle");
                ...
                BookList book = new BookList(title, title);
